...
def detect_and_load_data(data_dir):
    """
    Charge automatiquement les fichiers s'ils existent.
    Retourne un dict 'state' contenant :
      - reactions, comments, positions
      - df_all, activity_counts, events
      - files_info : dict nom_fichier -> bool (présent ou non)
    """
    expected_files = [
    ...
    # Chargement des fichiers utiles aux analyses actuelles
    ...
    # Préprocessing connections (important pour croissance réseau)
    ...
    # df_all = concat Réactions + Commentaires si présents
    ...
    # activity_counts (par mois et par type)
    ...
    # événements à partir de Positions (parcours pro)
    events = []
